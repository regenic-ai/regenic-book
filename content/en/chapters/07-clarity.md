...
*Figure: standards and data at ten percent each; trying means at eighty percent. The common ratio is inverted.*
...
[Figure 7-x: bioby logo (assets/bioby-logo.png)—insert with this paragraph during typesetting]
...
The organizational borrow-standard action chain has six links:
...
In 2020, community group buying was booming; Meituan launched Meituan Preferred. From public information the decision's reasoning path was very clear: another "takeout-style war." High frequency, rigid demand, subsidy burn, rapid scale, last player standing wins. Takeout had been won; fight the same way.

The problem: fresh grocery's first-order conditions are not isomorphic to takeout. Takeout fulfills standardized cooked food; fresh grocery fights high spoilage, thin margins, and cold-chain cost—three mountains. Takeout's scale effect rises with order volume; fresh spoilage rises with scale. These gaps were not hindsight. Contemporaries and industry research kept flagging them. But "takeout success" as the highest-weight internal sample overrode external boundary evidence.
...
Empiricism's chain: `personal experience → direct execution`
...
This book was produced on 10/10/80. I set the seven title standards once (10%), checked competing titles and name occupancy in one pass (10%), then eight candidates, multiple scoring rounds, iterative search for the optimal solution (80%). The winning title was not on my original short list. That the methodology works on me is why I dare publish it openly.
...
**Second, 10/10/80 is resource discipline, not a precise dial.** It constrains order of magnitude: do not spend the bulk on arguing and piling data. Reasonable ratios float by industry, but a 40/40/20 inversion is sickness in any industry.

**Third, sample quality—state it honestly.** Duan Yongping and Musk have first-hand texts and mechanisms with solid provenance; evidence for both as "Clarity Method winners" is mechanism-level, and a same-caliber quantitative contrast (companies that borrow standards vs companies that grope from scratch—success/failure distribution) is not yet built—that is the gap the bilateral sample mirror exposes when turned on this chapter. Meituan Preferred figures come from financial reports and public reporting; scope limits are noted. The logo case is my self-report, not externally verifiable—discount accordingly. One slot remains: a mid-size company case that crossed a capability bottleneck by "borrowing external solutions." Large-company stories feel distant; that slot is open—when filled, this chapter will sit closer.

## What to Do Monday Morning (principal-leader view)

Three steps, within half a day:

1. **Write one sentence, set two definitions**: Write the company's hardest current problem in one sentence. Define win and lose first—no reading cases then backfilling definitions.
2. **Force-borrow from five sources**: From peers, cross-industry, papers, products, and history, find at least one precedent that solved a similar problem—at least one winner and one loser. Rule: no evaluation until the list is full; when evaluating, ask only two questions—which of its applicable conditions hold here, which have changed?
3. **Feynman acceptance**: Pick the solution you most want to borrow; explain it without jargon to someone who knows nothing of the business (new hire, family member—either works). List every place you cannot explain clearly. That is next week's data-collection list and the distance this plan still sits from "ready to try."

Individuals and teams can install the reflection loop too. Minimum viable version: ten minutes before leaving work, three questions (Is there a standard? Did I follow it? Is there a better solution?)—write outputs in one document; after a week you have a candidate-standard list. That is page one of your personal standards library.

## Quotable Lines

1. The core of Clarity Method is borrowing: most answers you need already exist in the world, just not in your company.
2. Standards and data are worth only two-tenths; trying means is worth eight-tenths.
3. People with expanded options take multiple-choice tests; people without options take judgment tests—and the book is closed.
4. What you cannot explain clearly is where judgment has not truly become yours.
5. Experience does not arise automatically from events—only events reflected on and turned into updated standards become experience.
6. Winners tell you why a solution may hold; losers tell you when a solution must stop.
7. One-sided samples manufacture belief; bilateral samples distill standards.
8. Groping from scratch is not independent thinking—it is often repaying tuition others already paid.
9. Borrowing a standard must include its boundary; borrow without boundary and you borrowed only a story.
10. An analogy is an elevator pitch, not a business plan.
11. Everything has N solutions; an organization without a sorting standard can only compare shouting volume.
12. Judge by value is not a values slogan—it is the sorting standard forced out when seeking optimal solutions.
13. Clarity Method does not oppose experience; it opposes experience taking final interpretive authority without verification.
14. Borrow first, create later is not a conservative's strategy—radicals like Musk are no exception; he just borrows deeper.
15. Reflection without output is emotional review—the same thing as journaling to move yourself.
16. Spend 80% up front and you do not skip the two 10%s—you only buy the 80% over and over.

## Connections to Adjacent Chapters

- From Chapter 6: the standards engine's feed port—where standards come from. Old gene replaced in this chapter: empiricism (head-on confrontation).
- To Chapter 8: Clarity Method expands your own options internally; externally you still need others to see you among N options—Interference Method, narrowing the other party's options.

## Chapter Acceptance Self-Check (against chapter acceptance criteria)

1. One-sentence claim restatable ✓, and it follows from the core claim (judgment scarcity → methodology for producing judgment, first production line).
2. Whiteboard framework diagram ✓ (10/10/80 vs 40/40/20 ratio figure inserted + borrow-standard six-link chain + personal reflection–Feynman loop + bilateral sample mirror).

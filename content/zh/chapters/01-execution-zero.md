...
状态：完稿（v2.6，2026-08-28，约 8800 字；验收通过 2026-07-25；v2.2 旁白硬接清理并插入金字塔图；v2.4 按 prose-standard 畅读修订；v2.5 按当前 prose-standard 以整句改写为主修订；v2.6 按中文畅销书气口接气修订，持续公开修订）
...
变便宜的到底是什么？两样：**怎么做**（执行）和**去哪里查**（知识获取）。写代码、做报表、查案例、找先例，确实在归零。它们加起来也不等于思考。思考还有一个内核：**什么值得做**，在无限可选项里选出那一个，为它排除其他所有，并为这个排除承担后果。这个内核，AI 一分钱没降。
...
6. 畅读 ✓：按当前 prose-standard 以整句改写和中文畅销书接气为主完成修订；五戒与旁白条款无违规；出处为文内作者—年份或句末括注。

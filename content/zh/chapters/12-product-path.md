...
状态：完稿（v1.4，2026-07-31，约 9200 字；验收通过 2026-07-26，v1.1 扩写：教育市场三笔账、与爱为舞五步走法、换挡时刻表新节、Meta 内部备忘录、闸门一走样例、个人附注；v1.2 补注意力稀缺对三笔账的加价效应（呼应第 8 章 E19）；v1.3 新增第三节"变量 × 不变量"选业乘法（含 bioby.ai 业务首次交代）；v1.4 第二节补正态分布读法、六档标准阶梯与双路径同构（HR/高考类比），待全书通读后冻结）
...
在读价格之前，先给这条曲线垫一层数学底：现实世界里，绝大多数对象的落点都可以按**正态分布**来解析——中间厚、两端薄。人、公司、产品用户，都挤在这条钟形曲线上；真正稀缺的标准，落在两端的细尾巴上。区分人时，多数场景不必发明一百种人格类型，**切成大约六档标准阶梯就够用**——六档从曲线一端排到另一端，每一档不是同一把尺子上的不同分数，而是**一套不同的验收标准**。普通公司的 HR 年薪十万，顶级公司的 HR 年薪百万：岗位名字都叫 HR，判断标准完全不是一套。中国高考把考生切进 C9、985、211、一本、二本、大专，每一档录取的是不同标准，不是"都叫大学生所以一样"。**从一个标准档跨到另一个标准档，就是跨越鸿沟**——鸿沟的物理含义不是情绪激动，是尺子换了：旧档练出来的肌肉，到新档常常直接清零。想读清华、上北大，结构上也只有两条路：天资与资本都顶格的人，可以走传统 A 路径，直接按最顶档标准竞争；普通人天资不够，更稳的是共识逆向迭代——先在已有成熟标准、无需重新教育自己的档位活下来，再一层一层换尺子往上挪。采用曲线上的用户分层，与这套标准阶梯同构：左端是最贵的标准（共识尚未形成，要教育市场），右端是最便宜的标准（共识已成熟，只需证明你更安全）。产品路径的选择，本质是**选从哪一档标准起跳，以及用哪条路换档**。
...
17. 岗位同名，标准不同；从一个标准档跨到另一个，才是鸿沟。
18. 现实落点按正态分布排布——稀缺的标准在两端，便宜的共识在右端。
